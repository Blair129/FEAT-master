...
class FSLTrainer(Trainer):
    ...
    def train(self):
        ...
        for epoch in range(1, args.max_epoch + 1):
            ...
            start_tm = time.time()
            for episode_index, (query_images, query_targets, support_images, support_targets) in enumerate(self.train_loader)
            # for batch in self.train_loader:
                ...
                # get saved centers
                logits, reg_logits = self.para_model(input_var2, input_var1)
